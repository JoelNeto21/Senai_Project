...
return [
    ...
    'navigation_items' => [
        ...
        ['id' => 'movements', 'label' => 'Movimentações', 'icon' => 'M', 'group' => 'Operação'],
        ['id' => 'overview', 'label' => 'Visão Geral', 'icon' => 'V', 'group' => 'Gestão'],
        ['id' => 'dashboard', 'label' => 'Dashboard', 'icon' => 'D', 'group' => 'Gestão'],
